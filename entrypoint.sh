...
for testvar in "BUGZILLA_DB_HOST" "BUGZILLA_DB_DRIVER" "BUGZILLA_DB_PORT" "BUGZILLA_DB_NAME" "BUGZILLA_DB_USER" "BUGZILLA_DB_PASS" "BUGZILLA_ADMIN_EMAIL" "BUGZILLA_ADMIN_PASS" "BUGZILLA_ADMIN_REALNAME"; do
  if [ -z ${!testvar+x} ]; then
